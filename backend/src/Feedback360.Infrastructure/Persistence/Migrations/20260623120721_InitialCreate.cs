        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SurveyTemplates_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Surveys_SurveyTemplates_TemplateId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Surveys_Users_SubjectEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                    SharedWithManagerId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplateShares", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemplateShares_SurveyTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "SurveyTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TemplateShares_Users_SharedWithManagerId",
                        column: x => x.SharedWithManagerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Responses_SurveyAssignments_AssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyAssignments_ReviewerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Surveys_SubjectEmployeeId",
                table: "Surveys",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyTemplates_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemplateShares_SharedWithManagerId",
                table: "TemplateShares",
                column: "SharedWithManagerId");
